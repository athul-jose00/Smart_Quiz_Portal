...
// Get user data
try {
  $stmt = $pdo->prepare("SELECT user_id, username, name, email, role FROM users WHERE user_id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($username) || empty($name) || empty($email) || empty($role)) {
    $error_message = "Username, name, email, and role are required.";
    ...
    try {
      ...
      if ($stmt->fetch()) {
        ...
        if (!empty($password)) {
          ...
          $stmt = $pdo->prepare("UPDATE users SET username = ?, name = ?, email = ?, password = ?, role = ? WHERE user_id = ?");
          $stmt->execute([$username, $name, $email, $hashed_password, $role, $user_id]);
        } else {
        ...
        <form method="POST" id="editUserForm">
          <div class="form-group">
            ...
            <input type="text" id="username" name="username" class="form-control"
              placeholder="Enter username" value="<?php echo htmlspecialchars($user['username']); ?>" required>
          </div>

          <div class="form-group">
            <label for="name">Full Name</label>
            <input type="text" id="name" name="name" class="form-control"
              placeholder="Enter full name" value="<?php echo htmlspecialchars($user['name']); ?>" required>
          </div>

          <div class="form-group">
            <label for="email">Email Address</label>
            <input type="email" id="email" name="email" class="form-control"
              placeholder="Enter email address" value="<?php echo htmlspecialchars($user['email']); ?>" required>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="password-strength">
              Leave blank to keep current password. If changing, password must be at least 6 characters long.
            </div>
          </div>
            ...
            <div class="role-selection">
              <div class="role-option role-student">
                <input type="radio" id="role_student" name="role" value="student"
                  <?php echo ($user['role'] === 'student') ? 'checked' : ''; ?>>
              ...
              <div class="role-option role-teacher">
                <input type="radio" id="role_teacher" name="role" value="teacher"
                  <?php echo ($user['role'] === 'teacher') ? 'checked' : ''; ?>>
